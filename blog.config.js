...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是Wendy, 欢迎来到ZLWSG',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Wendy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'ZLWSG是一家新兴的新加坡科技公司，专注于软件开发和信息技术服务', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zlwgs.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ZLW,ZLWSG,科技公司,公司网站', // 网站关键词 英文逗号隔开
